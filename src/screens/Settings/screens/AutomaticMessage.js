...
export default function AutomaticMessage({ navigation }) {
    ...
    return (
        <View style={{flex: 1, backgroundColor: theme.background}}>
            ...
            <Text style={{ fontSize: 11, fontWeight: '600', color: theme.subtitle, textTransform: 'uppercase', letterSpacing: 0.8, marginRight: 16, marginLeft: 16, marginTop: 16 }}>Resumo Diário</Text>
            <Card style={{ padding: 10, marginLeft: 16, marginRight: 16, marginTop: 8, backgroundColor: theme.card }}>
                <Card.Content>
                    <View>
                        <Text style={{ fontSize: 15, color: theme.text }}>Notificações de Agendamento</Text>
                        <Text style={{ fontSize: 14, color: theme.subtitle }}>Seja notificado dos agendamentos do dia</Text>
                    </View>
                    <View style={{ marginTop: 20 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Text style={{ fontSize: 16, color: theme.text }}>Horário do envio</Text>
            ...
            <Text style={{ fontSize: 11, fontWeight: '600', color: theme.subtitle, textTransform: 'uppercase', letterSpacing: 0.8, marginRight: 16, marginLeft: 16, marginTop: 16 }}>Dias de Recebimento</Text>
            <Card style={{ padding: 10, marginLeft: 16, marginRight: 16, marginTop: 8, backgroundColor: theme.card }}>
                <Card.Content>
                    {days.map((day) => (
                        <View key={day.key} style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Text></Text>
                            <Text style={{ fontSize: 16, color: theme.text }}>{day.name}</Text>
                            <Checkbox.Item
